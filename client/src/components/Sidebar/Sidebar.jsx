...
import { BsCursor, BsFillQuestionSquareFill } from "react-icons/bs";
    ...
    >
      <div className=" p-[20px] ">
        <ul className="sidebarList m-0 p-0">
         ...
         <li>
          <MdGroups />
          <span style={{ cursor: "pointer" }}>A2SV Community</span>
        </li>

          <li>
            <MdGroups />
            <span style={{ cursor: "pointer" }}>GDSC Community</span>
          </li>
          <li>
            <MdGroups />
            <span style={{ cursor: "pointer" }}>ALX Community</span>
          </li>
          {/* <li>
            <IoChatboxEllipsesSharp />
            <span>Chat</span>
          ...
          <li>
            <BsFillQuestionSquareFill />
            <span>Popular Codeforces Problems</span>
          </li>
          <li>
            <IoBriefcase />
            <span>Jobs</span>
        ...
        <div className="button">
          <button className="rounded-md bg-slate-200  w-[150px] p-[10px]" style={ {color : "black"}}>
            {" "}
            See More
          </button>
        </div>
